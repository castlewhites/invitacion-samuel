...
const invitados = [
    ...
    { id: 9, nombre: "CAMI ALARCÓN Y FAMILIA", cupos: 2 },
    { id: 10, nombre: "ANGÉLICA DÍAZ Y FAMILIA", cupos: 2 },
    { id: 11, nombre: "ANGIE GÓMEZ Y FAMILIA", cupos: 3 },
    { id: 12, nombre: "JESSI CIFUENTES Y FAMILIA", cupos: 2 },
    { id: 13, nombre: "CATA CIFUENTES Y FAMILIA", cupos: 3 },
    { id: 14, nombre: "JUANCHO GÓMEZ Y MANUELA", cupos: 2 },
    ...
    { id: 21, nombre: "JEFFER DIAZ", cupos: 2 },
    { id: 22, nombre: "JENNY DIAZ Y FAMILIA", cupos: 3 },
    { id: 23, nombre: "JULY DIAZ", cupos: 1 },
    { id: 24, nombre: "KEVIN CASTIBLANCO Y FAMILIA", cupos: 2 },
    ...
    { id: 33, nombre: "MABEL MORA Y FAMILIA", cupos: 3 },
